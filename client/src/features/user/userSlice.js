...
export const createUser = createAsyncThunk('createUser', async (formData, thunkAPI) => {
    try {
...
export const updateUserSecurity = createAsyncThunk('updateUserSecurity', async ({ self, slug, formData }, thunkAPI) => {
    try {
...
export const deleteUser = createAsyncThunk('deleteUser', async ({ slug, password }, thunkAPI) => {
    try {
...
export const forceDeleteUser = createAsyncThunk('forceDeleteUser', async ({ slug, password }, thunkAPI) => {
    try {
...
export const restoreUser = createAsyncThunk('restoreUser', async ({ slug, password }, thunkAPI) => {
    try {
