...
const phuKienSchema = new mongoose.Schema(
    {
        name: {
            ...
            validate: {
                ...
                message: 'Please provide a `Phụ kiện` name',
            },
        },
...
phuKienSchema.plugin(emptyStringToNull);

module.exports = mongoose.models.PhuKien || mongoose.model('PhuKien', phuKienSchema);
